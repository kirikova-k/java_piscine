...
public class MessagesRepositoryJdbcImpl implements MessagesRepository {
    ...
    @Override
    public boolean update(Message message) throws NotSavedSubEntityException, SQLException {

        String sqlQuery = "UPDATE chat.msgs " +
                "SET room_id = ?, " +
                "sender = ?, " +
                "message = ?, " +
        ...
        try(Connection connection = ds.getConnection();
            ...
            statement.setInt(2, message.getAuthor().getId());
